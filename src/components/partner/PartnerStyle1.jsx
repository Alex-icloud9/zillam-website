                    ...
                    <div className="row align-center">
                        ...
                        <div className="col-lg-6 offset-lg-1">
                            <div className="partner-items">
                                <ul>
                                    <li><img src={logo1} alt="Image Not FOund" /></li>
                                    <li><img src={logo2} alt="Image Not FOund" /></li>
                                    <li><img src={logo7} alt="Image Not FOund" /></li>
                                    <li><img src={logo4} alt="Image Not FOund" /></li>
                                    <li><img src={logo5} alt="Image Not FOund" /></li>
                                    <li><img src={logo6} alt="Image Not FOund" /></li>
                                </ul>
                            </div>
                        </div>
                    </div>
